...
import chat.rox.chatview.ui.ChatEditBar;
import chat.rox.chatview.ui.ChatList;
import chat.rox.chatview.ui.ChatView;
import chat.rox.chatview.utils.AnchorMenuDialog;
import chat.rox.chatview.utils.ContextMenuDialog;
...
public class ChatHolderActionsImpl implements MessageHolder.ChatHolderActions {
    ...
    public void onLinkClicked(String url, Message message) {
        ...
        try {
            ...
            Log.e("Rox", exception.getMessage());
        }
    }
