...
public class FAQActions {
    ...
    private void enqueue(FAQRequestLoop.RoxRequest<?> request) {
    ...
    public void getItem(final String itemId,
        ...
        enqueue(new FAQRequestLoop.RoxRequest<FAQItemItem>(true) {
            @Override
    ...
    public void getStructure(final String structureId,
        ...
        callback.getClass(); // NPE
        enqueue(new FAQRequestLoop.RoxRequest<FAQStructureItem>(true) {
            @Override
    ...
    public void getCategory(final String categoryId,
        ...
        callback.getClass(); // NPE
        enqueue(new FAQRequestLoop.RoxRequest<FAQCategoryItem>(true) {
            @Override
    ...
    public void getSearch(final String query, final String categoryId, final int limit,
        ...
        callback.getClass(); //NPE
        enqueue(new FAQRequestLoop.RoxRequest<List<FAQSearchItemItem>>(true) {
            @Override
    ...
    public void like(final String itemId, final String deviceId,
        ...
        enqueue(new FAQRequestLoop.RoxRequest<DefaultResponse>(true) {
            @Override
    ...
    public void getCategoriesForApplication(final String application,
        ...
        enqueue(new FAQRequestLoop.RoxRequest<List<String>>(true) {
            @Override
