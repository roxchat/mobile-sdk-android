...
public interface RoxSession {
     ...
     * @throws IllegalStateException if the push system was not configured for this session by {@link Rox.SessionBuilder#setPushSystem}
     * @throws IllegalStateException if the RoxSession was destroyed
     * @throws RuntimeException if the method was called not from the thread the RoxSession was created in
     * @see Rox.SessionBuilder#setPushToken
     */
    ...
    interface TokenCallback {
         ...
         * @param roxError - error that was occurred
         * @see TokenError
         */
        void onFailure(RoxError<TokenError> roxError);
    ...
    /**
     *  @see Rox.SessionBuilder#build(SessionCallback)
     */
    interface SessionCallback {
         ...
         * @see SessionError
         */
        void onFailure(RoxError<SessionError> sessionError);
