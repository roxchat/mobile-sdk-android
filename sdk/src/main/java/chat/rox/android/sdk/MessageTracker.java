...
public interface MessageTracker {
     ...
     * @throws IllegalStateException if the MessageTracker or the RoxSession was destroyed
     ...
     * @throws IllegalStateException if the MessageTracker or the RoxSession was destroyed
     * @throws RuntimeException if the method called not from the thread on which the RoxSession was created
     */
    void destroy();
