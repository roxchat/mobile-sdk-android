...
public interface MessageStream {
     ...
     * @param reaction reaction for message
     * @param callback callback for handling result
     */
    @CustomMethod
    void reactMessage(@NonNull Message message,
    ...
    interface GeolocationCallback {
         ...
         */
        void onFailed(RoxError<GeolocationError> geolocationError);

        /**
         * @see GeolocationCallback#onFailed(RoxError)
         */
    ...
    /**
     * Sets the listener of {@link RoxSession} online status changes.
    ...
    /**
     * This method clears the all history on the server
     */
    @CustomMethod
    ...
    interface SurveyAnswerCallback {
         ...
         */
        void onFailure(RoxError<SurveyAnswerError> roxError);

        /**
         * @see SurveyAnswerCallback#onFailure(RoxError)
         */
    ...
    interface SurveyCloseCallback {
         ...
         */
        void onFailure(RoxError<SurveyCloseCallback.SurveyCloseError> roxError);

        /**
         * @see SurveyCloseCallback#onFailure(RoxError)
         */
    ...
    /**
     * @see MessageStream#reactMessage(Message, MessageReaction, MessageReactionCallback)
     * */
    interface MessageReactionCallback {

        /**
         * Invoked when message was successfully reacted
         */
        void onSuccess(@NonNull Message.Id messageId);

        /**
         * Invoked when an error occurred while reacting message
         */
        void onFailure(@NonNull Message.Id messageId,
                       @NonNull RoxError<MessageReactionError> error);

        /**
         * @see MessageReactionCallback#onFailure(Message.Id, RoxError)
         */
        enum MessageReactionError {

            /**
             * When reaction of this message can't change
             */
            UNABLE_CHANGE_REACTION,

            /**
             * When message reaction is forbidden, because of server settings or visitor message
             */
            REACTION_FORBIDDEN,
            ...
            /**
             * Reacting message is turned off on the server.
             */
            NOT_ALLOWED,

            /**
             * Reacting message doesn't belong visitor.
             */
            MESSAGE_NOT_OWNED,
    ...
    interface DataMessageCallback {
         ...
         */
        void onFailure(@NonNull Message.Id messageId,
                       @NonNull RoxError<DataMessageError> dataMessageError);

        /**
         * @see DataMessageCallback#onFailure(Message.Id, RoxError)
         */
    ...
    interface SendFilesCallback {
         ...
         */
        void onFailure(@NonNull Message.Id messageId,
                       @NonNull RoxError<SendFileCallback.SendFileError> sendFilesError);
    }
    ...
    interface SendKeyboardCallback {
         ...
         */
        void onFailure(@NonNull Message.Id messageId,
                       @NonNull RoxError<SendKeyboardError> error);

        /**
         * @see SendKeyboardCallback#onFailure(Message.Id, RoxError)
         */
    ...
    interface EditMessageCallback {
         ...
         */
        void onFailure(@NonNull Message.Id id, @NonNull RoxError<EditMessageError> error);
    ...
    interface DeleteMessageCallback {
         ...
         */
        void onFailure(@NonNull Message.Id id, @NonNull RoxError<DeleteMessageError> error);
    ...
    interface SendFileCallback {
         ...
         * @see SendFileError
         */
        void onFailure(@NonNull Message.Id id, @NonNull RoxError<SendFileError> error);
    ...
    interface UploadFileToServerCallback {
         ...
         */
        void onFailure(@NonNull Message.Id id, @NonNull RoxError<SendFileCallback.SendFileError> error);
    }
    ...
    interface DeleteUploadedFileCallback {
         ...
         */
        void onFailure(@NonNull RoxError<DeleteUploadedFileError> error);
    ...
    interface RateOperatorCallback {
         ...
         */
        void onFailure(@NonNull RoxError<RateOperatorError> rateOperatorError);
    ...
    interface SendDialogToEmailAddressCallback {
         ...
         */
        void onFailure(@NonNull RoxError<SendDialogToEmailAddressError> error);
    ...
    interface SendStickerCallback {
        ...
        /**
         * Invoked if sending failure.
         * @param sendStickerErrorRoxError Error
         * @see SendStickerError
         */
        void onFailure(@NonNull RoxError<SendStickerError> sendStickerErrorRoxError);
