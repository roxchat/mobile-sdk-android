...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    private static void generateNotification(Context context,
        ...
        if (cls != null) {
            ...
            notificationIntent.putExtra(RoxChatActivity.EXTRA_SHOW_RATING_BAR_ON_STARTUP, type == RoxPushNotification.NotificationType.RATE_OPERATOR);
        ...
        builder.setSmallIcon(R.drawable.logo_rox_status_bar)
